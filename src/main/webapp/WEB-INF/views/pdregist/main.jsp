...
<div class="main_slider"
	style="background-image: url(/resources/elesco/images/test1.jpg)">
								...
								<div class="product-item">
									<div class="product discount">
										<div class="product_image">
											<img
												src="C:\Users\hi-guro\git\Final_Boot2\src\main\resources\static\Upload${PdVo.filename}"
												style="height: 220px">
										</div>
										<div class="favorite favorite_left"></div>
										<div class="product_info">
											<h6 class="product_name">
												<a href='./main?pdcode=${PdVo.pd_code}'>제목칸</a>
											</h6>
				...
				<div class="product-grid"
					...
					<div class="product-item men">
						<div class="product discount product_filter">
							...
							<div class="product_info">
								<h6 class="product_name">
									<a href='./main?pdcode=${PdVo.pd_code}'>${PdVo.pd_title}</a>
								</h6>
								<div class="product_price">${PdVo.price}</div>
							</div>
						</div>
