...
public class Criteria {
	...
	// Page580 Criteria 수정 : 게시물의 삭제 후에 페이지 번호나 검색 조건을 유지하면서
	// 이동하기 위해서는 'redirect'에 필요한 파라미터들을 매번 추가해야 하는 불편함이 있습니다.
	// UriComponentsBuilder 클래스를 활용하여 브라우저에서 GET 방식 등의 파라미터 전송에
	// 사용되는 문자열(쿼리스트링 query string)을 손쉽게 처리하도록 합니다.
